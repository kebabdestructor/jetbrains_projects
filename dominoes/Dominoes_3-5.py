...
class Dominoes:
    ...
    def handle_player_move(self):
        ...
        if user_input == 0:
            ...
            removed_piece = self.remove_piece_from_hand(user_input, self.player_pieces)
            self.add_piece_to_snake(user_input, removed_piece)
    ...
    def handle_computer_move(self, user_input):
        ...
        if random_n == 0:
            ...
            removed_piece = self.remove_piece_from_hand(random_n, self.computer_pieces)
            self.add_piece_to_snake(random_n, removed_piece)
