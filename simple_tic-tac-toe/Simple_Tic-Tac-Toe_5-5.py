...
def check_cells(matrix, XO_turn):
    ...
    if (not x_winner and not o_winner) and len(empty_cells) == 0:
        ...
        return check_user_turn(matrix, XO_turn)


def check_user_turn(matrix, XO_turn):
    try:
